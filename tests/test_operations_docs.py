...
class OperationsDocsTests(unittest.TestCase):
    ...
    def test_local_runbook_mentions_core_services(self):
        ...
        self.assertIn("/api/v1/models", text)
        self.assertIn("/api/v1/models/unload", text)
        self.assertIn("/api/v1/models/load", text)
        self.assertIn("Other loaded models are not touched", text)
        self.assertIn("gemma-2b4", text)
        self.assertIn("192.168.0.10", text)
        ...
        self.assertIn("bot_sessions", text)
        self.assertIn("Assistant", text)
        self.assertIn("Ops", text)
        self.assertIn("active bot flow", text)
        ...
        self.assertIn("TELEGRAM_DATA_DIR", text)
